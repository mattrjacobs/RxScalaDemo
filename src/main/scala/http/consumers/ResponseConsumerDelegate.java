 ...
 */
package com.mattrjacobs.rxscala.http.consumers;
...
import rx.Observer;
import com.mattrjacobs.rxscala.http.ObservableHttpResponse;
...
public class ResponseConsumerDelegate extends AbstractAsyncResponseConsumer<HttpResponse> {
    ...
    protected void onResponseReceived(HttpResponse response) throws HttpException, IOException {
        ...
        if (responseIsStreamLike(response)) {
            System.out.println("Streaming HTTP Response!");
            consumer = new ResponseConsumerEventStream(observer, subscription);
        } else {
            System.out.println("Normal HTTP Response!");
